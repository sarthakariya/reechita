document.addEventListener('DOMContentLoaded', () => {
    ...
    if (preloader) {
        ...
        if (preloaderMessage) preloaderMessage.style.opacity = '0';
        ...
        setTimeout(() => {
            ...
            if (preloaderMessage) {
                preloaderMessage.style.transition = 'opacity 1s ease-out 0.2s';
        ...
        const interval = setInterval(() => {
            loadProgress += 1; // Faster loading for visual effect
        ...
        }, 30); // Very fast progress for a smooth visual loading experience
